...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1566093353;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__session__get_status_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__health_check_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__is_another_instance_running_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__is_model_downloaded_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__list_audio_devices_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__list_available_models_impl(port, ptr, rust_vec_len, data_len),
        17 => {
        ...
        21 => wire__crate__session__record_segment_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__release_instance_lock_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__export__sanitize_filename_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__save_settings_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__settings__save_settings_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__audio__session_config_for_mode_impl(port, ptr, rust_vec_len, data_len),
        27 => {
            wire__crate__audio__session_mode_default_toggles_impl(port, ptr, rust_vec_len, data_len)
        }
        28 => wire__crate__audio__session_mode_echo_dedupe_enabled_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        29 => wire__crate__api__set_session_mode_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__session__set_session_mode_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__start_session_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__session__start_session_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__stop_session_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__session__stop_session_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__toggle_mic_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__session__toggle_mic_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__toggle_speaker_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__session__toggle_speaker_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
